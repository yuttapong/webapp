            ...
            <?php if (!Yii::$app->user->isGuest) : ?>
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown notifications-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li class="header hidden">คุณมี 10 รายการอนุมัติ</li>
                            <li>
                                <?php
                                if ($newMessages) {
                                    echo ' <ul class="menu">';
                                    foreach ($newMessages as $message) {
                                        if ($message['countNew'] > 0) {
                                            echo '<li>';
                                            echo '<a href="' . Yii::$app->urlManager->baseUrl . '' . $message['url_message'] . '"><span class="label label-danger">' . $message['countNew'] . '</span> ' . $message['document'];
                                            echo '</a>';
                                            echo '</li>';
                                        }
                                    }
