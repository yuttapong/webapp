...
?>
    ...
    <div id="panel-option-values" class="panel panel-default">
        ...
        <table class="table table-bordered table-striped margin-b-none">
            ...
            <?php foreach ($modelsGallery as $index => $modelOptionValue): ?>
                ...
                <tr class="form-options-item">
                    ...
                    <td class="vcenter">
                        ...
                        <?= $form->field($modelOptionValue, "[{$index}]img")
                            ->label()
                            ->textInput(); ?>
                    ...
                    <td>
                        ...
                        <?php if (!$modelOptionValue->isNewRecord): ?>
                            ...
                            <?= Html::activeHiddenInput($modelOptionValue, "[{$index}]_id"); ?>

                            <?= Html::activeHiddenInput($modelOptionValue, "[{$index}]user_id"); ?>

                            <?= Html::activeHiddenInput($modelOptionValue, "[{$index}]is_deleted"); ?>
