...

{
...

    {
        ...
        $query->joinWith(['customer','personnel']);
        $query->where(['crm_customer_responsible.active'=>Customer::STATUS_ACTIVE]);
        $query->andFilterWhere(['crm_customer_responsible.user_id'=>Yii::$app->user->id]);
...
public function searchOnlyParamsAll($params)
