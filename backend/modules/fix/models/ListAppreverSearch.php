...
/**
 * ListAppreverSearch represents the model behind the search form about `backend\modules\fix\Models\ListApprever`.
 */
class ListAppreverSearch extends ListApprever
{
    /**
     * @inheritdoc
     */
